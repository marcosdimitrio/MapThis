...
namespace MapThis.Services.CompoundGenerator
{
    public class ListMapGenerator : ICompoundMethodGenerator
    {
        ...
        public ListMapGenerator(MapCollectionInformationDto mapCollectionInformationDto, ISingleMethodGeneratorService singleMethodGeneratorService, CodeAnalysisDependenciesDto codeAnalisysDependenciesDto)
        {
        ...
        private IList<INamespaceSymbol> GetNamespaces()
        {
            ...
            {
                MapCollectionInformationDto.MethodInformation.SourceType.ContainingNamespace,
                MapCollectionInformationDto.MethodInformation.TargetType.ContainingNamespace,
            };
